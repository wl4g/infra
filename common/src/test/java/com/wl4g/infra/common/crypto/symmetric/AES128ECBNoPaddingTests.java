...
/**
 * {@link AES128ECBNoPaddingTests}
 * 
 * @author James Wong
 * @version 2023-01-05
 * @since v1.0.0
 */
public class AES128ECBNoPaddingTests {

    @Test
    public void testAes128EcbNoPadding() throws Exception {
        ...
        // The encryption
        // ECB 模式不支持 IV
        final CodecSource encrypted = new AES128ECBNoPadding().encrypt(key, null, new CodecSource(srcStr));
        System.out.println("encrypted(hex):" + encrypted.toHex());

        // The decryption
        final CodecSource src2 = new AES128ECBNoPadding().decrypt(key, null, encrypted);
