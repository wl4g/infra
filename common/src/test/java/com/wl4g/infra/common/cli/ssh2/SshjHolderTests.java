...
public class SshjHolderTests {
    ...
    public static void sshjExecTest() throws Exception {
        ...
        SSH2Holders.Ssh2ExecResult sshExecResponse = SSH2Holders.getInstance(SshjHolder.class).execWaitForResponse("10.0.0.160",
                "root", PRIVATE_KEY.toCharArray(), null, "mvn -version", 60000);
    ...
    public static void sshjScpTest() throws Exception {
        ...
        SSH2Holders.getInstance(SshjHolder.class).scpPutFile("10.0.0.160", "root", PRIVATE_KEY.toCharArray(), null,
