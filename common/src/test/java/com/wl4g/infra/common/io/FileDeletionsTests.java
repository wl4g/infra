 ...
 * @see
 */
public class FileDeletionsTests {
    ...
    public void deleteWithPatternCase1() {
        ...
        FileDeleteUtil.delete("/tmp/fileDeletion/dir2", true, false);
    }
    ...
    public void deleteWithPatternCase3() {
        ...
        FileDeleteUtil.delete("/tmp/fileDeletion/dir2/*", false, false);
    }
    ...
    public void deleteWithPatternCase5() {
        ...
        FileDeleteUtil.delete("/tmp/fileDeletion/**/file*.txt", true, false);
    }
