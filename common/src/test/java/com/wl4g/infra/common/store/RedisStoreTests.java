...
/**
 * {@link RedisStoreTests}
 * 
 * @author James Wong
 * @version 2022-11-02
 * @since v3.0.0
 */
public class RedisStoreTests extends BaseJedisServiceTests {

    @Test
    public void testPutGetRemove() throws Exception {
        try (RedisMapStore store = new RedisMapStore(jedisService, MyUser.class, "teststore");) {
