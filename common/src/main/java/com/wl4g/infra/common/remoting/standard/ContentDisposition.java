...
public final class ContentDisposition {
     ...
     */
    private ContentDisposition(@Nullable String type, @Nullable String name, @Nullable String filename, @Nullable Charset charset,
            @Nullable Long size, @Nullable ZonedDateTime creationDate, @Nullable ZonedDateTime modificationDate,
    ...
    private static String decodeFilename(String filename, Charset charset) {
        Assert2.notNull(filename, "'input' String` should not be null");
        Assert2.notNull(charset, "'charset' should not be null");
    ...
    private static String encodeFilename(String input, Charset charset) {
        Assert2.notNull(input, "`input` is required");
        Assert2.notNull(charset, "`charset` is required");
        Assert2.isTrue(!StandardCharsets.US_ASCII.equals(charset), "ASCII does not require encoding");
        Assert2.isTrue(UTF_8.equals(charset) || ISO_8859_1.equals(charset), "Only UTF-8 and ISO-8859-1 supported.");
    ...
    public interface Builder {
         ...
         * 
         * @deprecated since 5.2.3 as per <a href=
         *             "https://tools.ietf.org/html/rfc6266#appendix-B">RFC
         *             6266, Apendix B</a>, to be removed in a future release.
         */
        @Deprecated
    ...
    private static class BuilderImpl implements Builder {
        ...
        public BuilderImpl(String type) {
            Assert2.hasText(type, "'type' must not be not empty");
            this.type = type;
        }
        ...
        public Builder filename(String filename) {
            Assert2.hasText(filename, "No filename");
            this.filename = filename;
            return this;
        }
        ...
        public ContentDisposition build() {
            return new ContentDisposition(this.type, this.name, this.filename, this.charset, this.size, this.creationDate,
                    this.modificationDate, this.readDate);
        }
    }
