 ...
 *
 * <p>
 * Provides options to create {@link UriBuilder} instances with a common base
 * URI, alternative encoding mode strategies, among others.
 *
...
public class DefaultUriBuilderFactory implements UriBuilderFactory {
    ...
    public DefaultUriBuilderFactory(EncodingMode encodingMode) {
        this.baseUri = null;
    ...
    private class DefaultUriBuilder implements UriBuilder {
        ...
        private UriComponentsBuilder initUriComponentsBuilder(String uriTemplate) {
            ...
            if (StringUtils2.isBlank(uriTemplate)) {
