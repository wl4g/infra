...
class SortedProperties extends Properties {
    ...
    /**
     * Construct a new {@code SortedProperties} instance that honors the
     * supplied {@code omitComments} flag.
     * 
     * @param omitComments
    ...
    /**
     * Construct a new {@code SortedProperties} instance with properties
     * populated from the supplied {@link Properties} object and honoring the
     * supplied {@code omitComments} flag.
     * <p>
     * Default properties from the supplied {@code Properties} object will not
     * be copied.
     * 
     * @param properties
