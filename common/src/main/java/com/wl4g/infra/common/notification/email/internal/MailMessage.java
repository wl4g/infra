 ...
 * values required in assembling a mail message, without needing to know if the
 * underlying message is a simple text message or a more sophisticated MIME
 * message.
 *
 * <p>
 * Implemented by both SimpleMailMessage and MimeMessageHelper, to let message
 * population code interact with a simple message or a MIME message through a
 * common interface.
 *
