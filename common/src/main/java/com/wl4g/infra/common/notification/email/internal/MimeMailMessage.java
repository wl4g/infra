...
/**
 * Implementation of the MailMessage interface for a JavaMail MIME message, to
 * let message population code interact with a simple message or a MIME message
