 ...
 * querying the IP2Location Web Service.
 * <p>
...
public class IP2LocationWebService {
     ...
     * @param Package
     *            IP2Location Web Service package (WS1 to WS25)
     ...
     *            IP2Location Web Service package (WS1 to WS25)
     * @param UseSSL
     *            Set to true to call the web service using SSL
     * @throws IllegalArgumentException
     *             If an invalid parameter is specified
     */
     ...
     *             If an exception occurred at runtime
     */
     ...
     *            IP Address you wish to query
     * @param AddOns
     *            The list of AddOns results to return
     * @param Language
     *            The translation language
     * @return IP2Location data
     * @throws IllegalArgumentException
     ...
     *             If an exception occurred at runtime
     */
    public JsonObject IPQuery(String IPAddress, String[] AddOns, String Language)
        ...
        try {
            ...
            bf.append("://api.ip2location.com/v2/?key=")
                    .append(_APIKey)
                    .append("&package=")
                    .append(_Package)
                    .append("&ip=")
            ...
            JsonObject myresult = JsonParser.parseString(myjson).getAsJsonObject();
            return myresult;
