...
public final class MediaTypeFactory {
    ...
    public static List<HttpMediaType> getMediaTypes(@Nullable String filename) {
        return Optional.ofNullable(StringUtils2.getFilenameExtension(filename))
    ...
    private static final String defaultMimeTypesFileName = MediaTypeFactory.class.getName()
            .replace(".", "/")
            .replace(MediaTypeFactory.class.getSimpleName(), "")
            .concat("mime.types");
