...
@Todo
public class BarkMessageNotifier extends AbstractMessageNotifier<BarkNotifierProperties> {

    public BarkMessageNotifier(BarkNotifierProperties config, Validator validator) {
