...
public class HttpClientErrorException extends HttpStatusCodeException {
    ...
    /**
     * Constructor with a status code and status text, headers, and content, and
     * an prepared message.
     * 
     * @since 5.2.2
     */
    public HttpClientErrorException(String message, HttpStatus statusCode, String statusText, @Nullable HttpHeaders headers,
            @Nullable byte[] body, @Nullable Charset responseCharset) {
        super(message, statusCode, statusText, headers, body, responseCharset);
    }

    /**
     * Create {@code HttpClientErrorException} or an HTTP status specific
     * sub-class.
     * 
     * @since 5.1
     */
    public static HttpClientErrorException create(HttpStatus statusCode, String statusText, HttpHeaders headers, byte[] body,
    ...
    /**
     * Variant of
     * {@link #create(HttpStatus, String, HttpHeaders, byte[], Charset)} with an
    ...
    public static HttpClientErrorException create(@Nullable String message, HttpStatus statusCode, String statusText,
        ...
        switch (statusCode) {
        case BAD_REQUEST:
            return message != null ? new HttpClientErrorException.BadRequest(message, statusText, headers, body, charset)
                    : new HttpClientErrorException.BadRequest(statusText, headers, body, charset);
        case UNAUTHORIZED:
            return message != null ? new HttpClientErrorException.Unauthorized(message, statusText, headers, body, charset)
        ...
        case METHOD_NOT_ALLOWED:
            return message != null ? new HttpClientErrorException.MethodNotAllowed(message, statusText, headers, body, charset)
                    : new HttpClientErrorException.MethodNotAllowed(statusText, headers, body, charset);
        case NOT_ACCEPTABLE:
            return message != null ? new HttpClientErrorException.NotAcceptable(message, statusText, headers, body, charset)
        ...
        case TOO_MANY_REQUESTS:
            return message != null ? new HttpClientErrorException.TooManyRequests(message, statusText, headers, body, charset)
                    : new HttpClientErrorException.TooManyRequests(statusText, headers, body, charset);
        case UNPROCESSABLE_ENTITY:
            return message != null ? new HttpClientErrorException.UnprocessableEntity(message, statusText, headers, body, charset)
                    : new HttpClientErrorException.UnprocessableEntity(statusText, headers, body, charset);
        default:
            return message != null ? new HttpClientErrorException(message, statusCode, statusText, headers, body, charset)
    ...
    /**
     * {@link HttpClientErrorException} for status HTTP 415 Unsupported Media
     * Type.
     * 
     * @since 5.1
     */
    ...
    /**
     * {@link HttpClientErrorException} for status HTTP 422 Unprocessable
     * Entity.
     * 
     * @since 5.1
     */
