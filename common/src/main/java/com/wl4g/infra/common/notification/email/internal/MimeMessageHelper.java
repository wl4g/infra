 ...
 *
 * <p>
 * Offers support for HTML text content, inline elements such as images, and
 * typical mail attachments. Also supports personal names that accompany mail
 * addresses. Note that advanced settings can still be applied directly to the
 * underlying MimeMessage object!
 *
 * <p>
 * Typically used in {@link MimeMessagePreparator} implementations or
 * {@link JavaMailSender} client code: simply instantiating it as a MimeMessage
 * wrapper, invoking setters on the wrapper, using the underlying MimeMessage
 * for mail sending. Also used internally by {@link JavaMailSenderImpl}.
 *
 * <p>
 ...
 *
 * <p>
 * <b>Warning regarding multipart mails:</b> Simple MIME messages that just
 * contain HTML text but no inline elements or attachments will work on more or
 * less any email client that is capable of HTML rendering. However, inline
 * elements and attachments are still a major compatibility issue between email
 * clients: It's virtually impossible to get inline elements and attachments
 * working across Microsoft Outlook, Lotus Notes and Mac Mail. Consider choosing
 * a specific multipart mode for your needs: The javadoc on the MULTIPART_MODE
 * constants contains more detailed information.
 *
...
public class MimeMessageHelper {
     ...
     * element of type "mixed". Texts, inline elements and attachements will all
     * get added to that root element.
     * <p>
     * This was Spring 1.0's default behavior. It is known to work properly on
     * Outlook. However, other mail clients tend to misinterpret inline elements
     * as attachments and/or show attachments inline as well.
     */
    public static final int MULTIPART_MODE_MIXED = 1;

    /**
     * Constant indicating a multipart message with a single root multipart
     * element of type "related". Texts, inline elements and attachements will
     * all get added to that root element.
     * <p>
     * This was the default behavior from Spring 1.1 up to 1.2 final. This is
     * the "Microsoft multipart mode", as natively sent by Outlook. It is known
     * to work properly on Outlook, Outlook Express, Yahoo Mail, and to a large
     * degree also on Mac Mail (with an additional attachment listed for an
     * inline element, despite the inline element also shown inline). Does not
     * work properly on Lotus Notes (attachments won't be shown there).
     */
     ...
     * inline elements will get added to the nested "related" element, while
     * attachments will get added to the "mixed" root element.
     * <p>
    ...
    /**
     * Create a new MimeMessageHelper for the given MimeMessage, assuming a
     * simple text message (no multipart content, i.e. no alternative texts and
     * no inline elements or attachments).
     * <p>
     * The character encoding for the message will be taken from the passed-in
     * MimeMessage object, if carried there. Else, JavaMail's default encoding
     * will be used.
     * 
     * @param mimeMessage
     *            the mime message to work on
    ...
    /**
     * Create a new MimeMessageHelper for the given MimeMessage, in multipart
     * mode (supporting alternative texts, inline elements and attachments) if
     * requested.
     * <p>
     * Consider using the MimeMessageHelper constructor that takes a
     * multipartMode argument to choose a specific multipart mode other than
     ...
     *            the mime message to work on
     * @param multipartMode
     *            which kind of multipart message to create (MIXED, RELATED,
     *            MIXED_RELATED, or NO)
     * @throws MessagingException
     *             if multipart creation failed
    ...
    /**
     * Determine the MimeMultipart objects to use, which will be used to store
     * attachments on the one hand and text(s) and inline elements on the other
     * hand.
     * <p>
     * Texts and inline elements can either be stored in the root element itself
     * (MULTIPART_MODE_MIXED, MULTIPART_MODE_RELATED) or in a nested element
     ...
     * (MULTIPART_MODE_MIXED) or "related" (MULTIPART_MODE_RELATED). The main
     * multipart element will either be added as nested element of type
     * "related" (MULTIPART_MODE_MIXED_RELATED) or be identical to the root
     * element itself (MULTIPART_MODE_MIXED, MULTIPART_MODE_RELATED).
     * 
     * @param mimeMessage
     *            the MimeMessage object to add the root MimeMultipart object to
     * @param multipartMode
     *            the multipart mode, as passed into the constructor (MIXED,
     ...
     * 
     * @param root
     *            the root MimeMultipart object, which attachments will be added
     *            to; or {@code null} to indicate no multipart at all
     * @param main
     *            the main MimeMultipart object, which text(s) and inline
     *            elements will be added to (can be the same as the root
     *            multipart object, or an element nested underneath the root
     *            multipart element)
     */
    ...
    /**
     * Return whether this helper is in multipart mode, i.e. whether it holds a
     * multipart message.
     * 
    ...
    /**
     * Return the root MIME "multipart/mixed" object, if any. Can be used to
     * manually add attachments.
     * <p>
     * This will be the direct content of the MimeMessage, in case of a
     * multipart mail.
     * 
     * @throws IllegalStateException
     *             if this helper is not in multipart mode
     * @see #isMultipart
     * @see #getMimeMessage
    ...
    /**
     * Return the underlying MIME "multipart/related" object, if any. Can be
     * used to manually add body parts, inline elements, etc.
     * <p>
     * This will be nested within the root MimeMultipart, in case of a multipart
     * mail.
     * 
     * @throws IllegalStateException
     *             if this helper is not in multipart mode
     ...
     * @return the default encoding associated with the MimeMessage, or
    ...
    /**
     * Determine the default Java Activation FileTypeMap for the given
     * MimeMessage.
     * 
     * @param mimeMessage
     *            the passed-in MimeMessage
     * @return the default FileTypeMap associated with the MimeMessage, or a
     *         default ConfigurableMimeFileTypeMap if none found for the message
    ...
    /**
     * Set the Java Activation Framework {@code FileTypeMap} to use for
     * determining the content type of inline content and attachments that get
     * added to the message.
     * <p>
     * The default is the {@code FileTypeMap} that the underlying MimeMessage
     * carries, if any, or the Activation Framework's default
     ...
     * <p>
     * The default is {@code false} for standard MIME behavior; turn this to
     * {@code true} for compatibility with older email clients. On a related
     * note, check out JavaMail's {@code mail.mime.encodefilename} system
     * property.
     * <p>
     * <b>NOTE:</b> The default changed to {@code false} in 5.3, in favor of
    ...
    /**
     * Validate the given mail address. Called by all of MimeMessageHelper's
     * address setters and adders.
     * <p>
    ...
    public void setFrom(InternetAddress from) throws MessagingException {
        Assert2.notNull(from, "From address must not be null");
    ...
    public void setReplyTo(InternetAddress replyTo) throws MessagingException {
        Assert2.notNull(replyTo, "Reply-to address must not be null");
    ...
    public void setTo(InternetAddress to) throws MessagingException {
        Assert2.notNull(to, "To address must not be null");
        validateAddress(to);
        this.mimeMessage.setRecipient(Message.RecipientType.TO, to);
    }

    public void setTo(InternetAddress[] to) throws MessagingException {
        Assert2.notNull(to, "To address array must not be null");
    ...
    public void setCc(InternetAddress cc) throws MessagingException {
        Assert2.notNull(cc, "Cc address must not be null");
        validateAddress(cc);
        this.mimeMessage.setRecipient(Message.RecipientType.CC, cc);
    }

    public void setCc(InternetAddress[] cc) throws MessagingException {
        Assert2.notNull(cc, "Cc address array must not be null");
    ...
    public void setBcc(InternetAddress bcc) throws MessagingException {
        Assert2.notNull(bcc, "Bcc address must not be null");
        validateAddress(bcc);
        this.mimeMessage.setRecipient(Message.RecipientType.BCC, bcc);
    }

    public void setBcc(InternetAddress[] bcc) throws MessagingException {
        Assert2.notNull(bcc, "Bcc address array must not be null");
     ...
     * 
     * @param priority
     *            the priority value; typically between 1 (highest) and 5
     *            (lowest)
     * @throws MessagingException
     *             in case of errors
     */
     ...
     * 
     * @param sentDate
     *            the date to set (never {@code null})
     * @throws MessagingException
     *             in case of errors
     */
    public void setSentDate(Date sentDate) throws MessagingException {
        Assert2.notNull(sentDate, "Sent date must not be null");
    ...
    public void setSubject(String subject) throws MessagingException {
        Assert2.notNull(subject, "Subject must not be null");
        if (getEncoding() != null) {
    ...
    /**
     * Set the given text directly as content in non-multipart mode or as
     * default body part in multipart mode. Always applies the default content
     * type "text/plain".
     * <p>
     * <b>NOTE:</b> Invoke {@link #addInline} <i>after</i> {@code setText};
     * else, mail readers might not be able to resolve inline references
     * correctly.
     * 
     * @param text
    ...
    /**
     * Set the given text directly as content in non-multipart mode or as
     * default body part in multipart mode. The "html" flag determines the
     * content type to apply.
     * <p>
     * <b>NOTE:</b> Invoke {@link #addInline} <i>after</i> {@code setText};
     * else, mail readers might not be able to resolve inline references
     * correctly.
    ...
    /**
     * Set the given plain text and HTML text as alternatives, offering both
     * options to the email client. Requires multipart mode.
     * <p>
     * <b>NOTE:</b> Invoke {@link #addInline} <i>after</i> {@code setText};
     * else, mail readers might not be able to resolve inline references
     * correctly.
     * 
     * @param plainText
     *            the plain text for the message
     * @param htmlText
    ...
    public void setText(String plainText, String htmlText) throws MessagingException {
        Assert2.notNull(plainText, "Plain text must not be null");
        Assert2.notNull(htmlText, "HTML text must not be null");
     ...
     * <p>
     * <b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@link #setText};
     * else, mail readers might not be able to resolve inline references
     * correctly.
     * 
     * @param contentId
     *            the content ID to use. Will end up as "Content-ID" header in
     *            the body part, surrounded by angle brackets: e.g. "myId"
     *            &rarr; "&lt;myId&gt;". Can be referenced in HTML source via
     *            src="cid:myId" expressions.
     * @param dataSource
     *            the {@code javax.activation.DataSource} to take the content
     *            from, determining the InputStream and the content type
     * @throws MessagingException
     *             in case of errors
    ...
    public void addInline(String contentId, DataSource dataSource) throws MessagingException {
        Assert2.notNull(contentId, "Content ID must not be null");
        Assert2.notNull(dataSource, "DataSource must not be null");
        MimeBodyPart mimeBodyPart = new MimeBodyPart();
     ...
     * (possibly ending in ".tmp" or the like)!
     * <p>
     * Note that the InputStream returned by the Resource implementation needs
     * to be a <i>fresh one on each call</i>, as JavaMail will invoke
     * {@code getInputStream()} multiple times.
     * <p>
     * <b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@link #setText};
     ...
     * @see #addInline(String, javax.activation.DataSource)
     */
    public void addInline(String contentId, StreamResource resource) throws MessagingException {
        Assert2.notNull(resource, "Resource must not be null");
     ...
     * {@code org.springframework.core.InputStreamResource}, and specifying the
     * content type explicitly.
     * <p>
     * You can determine the content type for any given filename via a Java
     * Activation Framework's FileTypeMap, for example the one held by this
     * helper.
     * <p>
     ...
     * <p>
     * <b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@code setText}; else,
     * mail readers might not be able to resolve inline references correctly.
     * 
     * @param contentId
     *            the content ID to use. Will end up as "Content-ID" header in
     *            the body part, surrounded by angle brackets: e.g. "myId"
     ...
     * @see #addInline(String, javax.activation.DataSource)
     */
    public void addInline(String contentId, StreamResource inputStreamSource, String contentType) throws MessagingException {

        Assert2.notNull(inputStreamSource, "InputStreamSource must not be null");
        if (inputStreamSource instanceof StreamResource && ((StreamResource) inputStreamSource).isOpen()) {
    ...
    public void addAttachment(String attachmentFilename, DataSource dataSource) throws MessagingException {
        Assert2.notNull(attachmentFilename, "Attachment filename must not be null");
        Assert2.notNull(dataSource, "DataSource must not be null");
        try {
            MimeBodyPart mimeBodyPart = new MimeBodyPart();
     ...
     *            the name of the attachment as it will appear in the mail
     * @param inputStreamSource
     *            the resource to take the content from (all of Spring's
     ...
     */
    public void addAttachment(String attachmentFilename, StreamResource inputStreamSource) throws MessagingException {
     ...
     * @see org.springframework.core.io.Resource
     */
    public void addAttachment(String attachmentFilename, StreamResource inputStreamSource, String contentType)
            throws MessagingException {
        Assert2.notNull(inputStreamSource, "InputStreamSource must not be null");
        if (inputStreamSource instanceof StreamResource && ((StreamResource) inputStreamSource).isOpen()) {
            throw new IllegalArgumentException("Passed-in Resource contains an open stream: invalid argument. "
     ...
     */
    protected DataSource createDataSource(final StreamResource inputStreamSource, final String contentType, final String name) {
    ...
    public static class SmartMimeMessage extends MimeMessage {
        ...
        /**
         * Return the default FileTypeMap of this message, or {@code null} if
         * none.
         */
        @Nullable
