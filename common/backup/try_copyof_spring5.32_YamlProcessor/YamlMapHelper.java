 ...
 * the earlier ones hierarchically; that is, all entries with the same nested
 * key of type {@code Map} at any depth are merged. For example:
 *
 * <pre class="code">
 * foo:
 *   bar:
 ...
 */
@Getter
public class YamlMapHelper extends YamlProcessor {

    @Nullable
    private Map<String, Object> map;

    public YamlMapHelper() {
        this.map = createMap();
    }
