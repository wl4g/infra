...
public class MemoryUtils {
     ...
     *
     * @param buffer
     *            {@link ByteBuffer} which wraps the native memory address to
     *            get
...
//        Preconditions.checkArgument(buffer.isDirect(), "Can't get address of a non-direct ByteBuffer.");
        ...
        isTrue(buffer.isDirect(), "Can't get address of a non-direct ByteBuffer.");
...
//        Preconditions.checkState(offHeapAddress < Long.MAX_VALUE - Integer.MAX_VALUE,
//                "Segment initialized with too large address: " + offHeapAddress + " ; Max allowed address is "
//                        + (Long.MAX_VALUE - Integer.MAX_VALUE - 1));
        // @formatter:on
        isTrue(offHeapAddress > 0, "negative pointer or size");
        isTrue(offHeapAddress < Long.MAX_VALUE - Integer.MAX_VALUE, "Segment initialized with too large address: "
                + offHeapAddress + " ; Max allowed address is " + (Long.MAX_VALUE - Integer.MAX_VALUE - 1));
