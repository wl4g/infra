 ...
 * 
 * @see Copy of
 *      https://github1s.com/apache/flink/blob/release-1.15.1/flink-runtime/src/main/java/org/apache/flink/runtime/state/CompositeKeySerializationUtils.java
 */
public class CompositeKeySerializationUtils {
    ...
    public static void writeKeyGroup(int keyGroup, int keyGroupPrefixBytes, DataOutputView keySerializationDateDataOutputView)
            throws IOException {
    ...
    private static void writeLengthFrom(int fromPosition, DataOutputSerializer keySerializationDateDataOutputView)
            throws IOException {
