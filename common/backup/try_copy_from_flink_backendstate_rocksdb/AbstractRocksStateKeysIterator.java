 ...
 * @see Copy of
 *      https://github1s.com/apache/flink/blob/release-1.15.1/flink-state-backends/src/main/java/org/apache/flink/contrib/streaming/state/AbstractRocksStateKeysIterator.java
 */
public abstract class AbstractRocksStateKeysIterator<K> implements AutoCloseable {
    ...
    public AbstractRocksStateKeysIterator(@Nonnull RocksIteratorWrapper iterator, @Nonnull String state,
    ...
    protected K deserializeKey(byte[] keyBytes, DataInputDeserializer readView) throws IOException {
        ...
        return CompositeKeySerializationUtils.readKey(keySerializer, byteArrayDataInputView, ambiguousKeyPossible);
    }
