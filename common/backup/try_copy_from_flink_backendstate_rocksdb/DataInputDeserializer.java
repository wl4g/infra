 ...
 * 
 * @see Copy of
 *      https://github1s.com/apache/flink/blob/release-1.15.1/flink-core/src/main/java/org/apache/flink/core/memory/DataInputDeserializer.java
 */
public class DataInputDeserializer implements DataInputView, java.io.Serializable {
    ...
    public void setBuffer(@Nonnull ByteBuffer buffer) {
        if (buffer.hasArray()) {
            ...
            // TODO: FLINK-8585 handle readonly and other non array based
            // buffers more efficiently
            // without data copy
