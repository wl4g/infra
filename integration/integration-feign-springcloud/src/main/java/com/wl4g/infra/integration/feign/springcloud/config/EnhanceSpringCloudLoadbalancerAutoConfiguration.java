...
// */
// package com.wl4g.infra.integration.feign.springcloud.config;
//
...
// import static
/// com.wl4g.infra.integration.feign.springcloud.constant.SpringCloudFeignConstant.*;
...
// import
/// org.springframework.cloud.loadbalancer.core.CachingServiceInstanceSupplier;
// import
/// org.springframework.cloud.loadbalancer.core.DiscoveryClientServiceInstanceSupplier;
// import
...
// LoadBalancerClientFactory clientFactory = new
/// ExtensionLoadBalancerClientFactory();
...
// /**
// * {@link
/// org.springframework.cloud.loadbalancer.blocking.client.BlockingLoadBalancerClient#choose}
// */
// @Bean
// @ConditionalOnProperty(name = CONFIG_PREFIX_LB_RANDOM + ".enabled",
/// matchIfMissing = false)
// @ConditionalOnMissingClass("org.springframework.cloud.loadbalancer.core.RandomLoadBalancer")
/// // spring-cloud-loadbalancer-3.0.0.jar
...
// @ConditionalOnProperty(name = CONFIG_PREFIX_LB_GRAY + ".enabled",
/// matchIfMissing = false)
...
// String name =
/// environment.getProperty(LoadBalancerClientFactory.PROPERTY_NAME);
// String chooseExpression = environment.getProperty(CONFIG_PREFIX_LB_GRAY +
/// ".chooseExpression", "");
// chooseExpression = isBlank(chooseExpression) ? "#{true}" : chooseExpression;
/// // by-default
...
/// environment.getProperty(LoadBalancerClientFactory.PROPERTY_NAME);
// return new
/// RoundRobinLoadBalancer(loadBalancerClientFactory.getLazyProvider(name,
/// ServiceInstanceListSupplier.class),
// name);
// }
//
// public static class ExtensionLoadBalancerClientFactory extends
/// LoadBalancerClientFactory {
// public ExtensionLoadBalancerClientFactory() {
// super();
// // [FIXED] Override default config type.
// Field defaultConfigTypeField = findField(getClass(), "defaultConfigType",
/// Class.class);
// setField(defaultConfigTypeField, this,
/// EnhanceSpringCloudLoadbalancerAutoConfiguration.class, true);
// }
// }
//
// /**
...
// *
// * @see {@link
/// org.springframework.cloud.loadbalancer.core.RoundRobinLoadBalancer.RoundRobinLoadBalancer}
// */
// public static class RandomLoadBalancer implements
/// ReactorServiceInstanceLoadBalancer {
// protected final SmartLogger log = getLogger(getClass());
// protected final Random random = new Random();
//
// private final String serviceId;
// private ObjectProvider<ServiceInstanceListSupplier>
...
// */
// public RandomLoadBalancer(ObjectProvider<ServiceInstanceListSupplier>
/// serviceInstanceListSupplierProvider,
// String serviceId) {
...
// }
//
// private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance>
/// instances) {
// if (instances.isEmpty()) {
// log.warn("No servers available for service: {}", this.serviceId);
// return new EmptyResponse();
// }
// ServiceInstance instance = instances.get(current().nextInt(0,
/// instances.size()));
...
// * Gray load balancer.
// */
// public static class GrayLoadBalancer implements
/// ReactorServiceInstanceLoadBalancer {
// protected final SmartLogger log = getLogger(getClass());
//
// private final String serviceId;
...
/// serviceInstanceListSupplierProvider;
//
// public GrayLoadBalancer(ObjectProvider<ServiceInstanceListSupplier>
...
// return
/// ServiceInstanceListSupplier.builder().withDiscoveryClient().withZonePreference().withCaching().build(context);
// }
//
// @Bean
// @ConditionalOnBean(ReactiveDiscoveryClient.class)
...
// DiscoveryClientServiceInstanceSupplier delegate = new
/// DiscoveryClientServiceInstanceSupplier(discoveryClient, env);
...
// ConfigurableApplicationContext context) {
// return
/// ServiceInstanceListSupplier.builder().withBlockingDiscoveryClient().withZonePreference().withCaching().build(
// context);
// }
//
// @Bean
...
// ConfigurableApplicationContext context) {
// return
/// ServiceInstanceListSupplier.builder().withBlockingDiscoveryClient().withHealthChecks().withCaching().build(
// context);
// }
//
// @Bean
...
// }
//
// private static final int REACTIVE_SERVICE_INSTANCE_SUPPLIER_ORDER =
/// 193827465;
