...
/**
 * {@link FeignSpringCloudClientsRegistrar}
 * 
...
class FeignSpringCloudClientsRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        if (!FrameworkType.FEIGN_SPRINGCLOUD.isActive()) {
            log.info("The current not Feign+SpringCloud environment and automatically skiped configuring.");
            return;
        }
        ...
        try {
                    ...
                    new Object[] { new AnnotationMetadata() {
                        ...
                        public Map<String, Object> getAnnotationAttributes(String annotationName) {
                            ...
                            if (annotationName.equals("org.springframework.cloud.openfeign.EnableFeignClients")) {
                                return metadata.getAnnotationAttributes(EnableFeignConsumers.class.getCanonicalName());
                            }
            ...
            throw new IllegalStateException(
                    format("Cannot to bridge invoke to SpringCloud '%s#registerBeanDefinitions'", FEIGNCLIENTS_REGISTRAR_CLASS),
                    e);
        }
    }
