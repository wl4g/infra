 ...
 */
package com.wl4g.infra.integration.feign.core;
...
@EnableFeignConsumers(basePackages = "com.wl4g.infra.integration.feign.core", defaultConfiguration = { SampleRetryer.class })
