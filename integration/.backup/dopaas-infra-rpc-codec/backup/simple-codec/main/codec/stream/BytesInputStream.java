...
public class BytesInputStream extends InputStream {
	...
	public long readLong() throws IOException {
		...
		if (isLittleEndian) {
			return (((long) longBuffer[7] << 56) + ((long) (longBuffer[6] & 255) << 48) + ((long) (longBuffer[5] & 255) << 40)
					+ ((long) (longBuffer[4] & 255) << 32) + ((long) (longBuffer[3] & 255) << 24) + ((longBuffer[2] & 255) << 16)
	...
	public String toString() {
		return StringHelper.buffer("BytesInputStream [pos=", pos, ", count=", count, ']',
				ByteHelper.toHexString(buffer, offsetStart, count));
	}
