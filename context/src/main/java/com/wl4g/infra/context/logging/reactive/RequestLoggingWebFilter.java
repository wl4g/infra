 ...
 */
@Slf4j
public class RequestLoggingWebFilter extends BaseLoggingWebFilter {

    public RequestLoggingWebFilter(LoggingMessageProperties loggingConfig, Environment environment) {
