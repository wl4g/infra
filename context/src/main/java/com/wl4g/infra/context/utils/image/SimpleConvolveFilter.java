 ...
 */
package com.wl4g.infra.context.utils.image;
 ...
 * @since
 */
public class SimpleConvolveFilter extends AbstractBufferedImageOp {
	 ...
	 */
	public SimpleConvolveFilter(float[] matrix) {
	 ...
	 */
	public SimpleConvolveFilter(int rows, int cols, float[] matrix) {
	 ...
	 *            an array of 9 floats containing the kernel
	 */
	public SimpleConvolveFilter(Kernel kernel) {
		this.kernel = kernel;
	}
