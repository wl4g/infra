 ...
 * under the License.
 */
package com.wl4g.infra.common.netty.ipfilter;
...
/**
 * @see https://github.com/netty/netty/blob/HEAD/handler/src/test/java/io/netty/handler/ipfilter/IpSubnetFilterTest.java
 */
public class IpSubnetFilterTest {
    ...
    public void testIpv4DefaultRoute() {
        ...
        Assertions.assertTrue(rule.matches(newSockAddress("91.114.240.43")));
        Assertions.assertTrue(rule.matches(newSockAddress("10.0.0.3")));
        Assertions.assertTrue(rule.matches(newSockAddress("192.168.93.2")));
    }

    @Test
    public void testIpv4SubnetMaskCorrectlyHandlesIpv6() {
        IpSubnetFilterRule rule = new IpSubnetFilterRule("0.0.0.0", 0, IpFilterRuleType.ACCEPT);
        Assertions.assertFalse(rule.matches(newSockAddress("2001:db8:abcd:0000::1")));
    }
    ...
    public void testIpv6SubnetMaskCorrectlyHandlesIpv4() {
        ...
        Assertions.assertFalse(rule.matches(newSockAddress("91.114.240.43")));
    }
    ...
    public void testIp4SubnetFilterRule() throws Exception {
        ...
        for (int i = 0; i <= 255; i++) {
            Assertions.assertTrue(rule.matches(newSockAddress(String.format("192.168.56.%d", i))));
        }
        Assertions.assertFalse(rule.matches(newSockAddress("192.168.57.1")));

        rule = new IpSubnetFilterRule("91.114.240.1", 23, IpFilterRuleType.ACCEPT);
        Assertions.assertTrue(rule.matches(newSockAddress("91.114.240.43")));
        Assertions.assertTrue(rule.matches(newSockAddress("91.114.240.255")));
        Assertions.assertTrue(rule.matches(newSockAddress("91.114.241.193")));
        Assertions.assertTrue(rule.matches(newSockAddress("91.114.241.254")));
        Assertions.assertFalse(rule.matches(newSockAddress("91.115.241.2")));
    }
    ...
    public void testIp6SubnetFilterRule() {
        ...
        Assertions.assertTrue(rule.matches(newSockAddress("2001:db8:abcd:0000::1")));
        Assertions.assertTrue(rule.matches(newSockAddress("2001:db8:abcd:0fff:ffff:ffff:ffff:ffff")));
        Assertions.assertFalse(rule.matches(newSockAddress("2001:db8:abcd:1000::")));
    }

    @Test
    public void testIp6SubnetFilterDefaultRule() {
        IpFilterRule rule = new IpSubnetFilterRule("::", 0, IpFilterRuleType.ACCEPT);
        Assertions.assertTrue(rule.matches(newSockAddress("7FFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF:FFFF")));
        Assertions.assertTrue(rule.matches(newSockAddress("8000::")));
    }
    ...
    public void testIpFilterRuleHandler() throws Exception {
        ...
        RuleBasedIpFilter denyHandler = new RuleBasedIpFilter(filter0) {
            ...
            protected ChannelFuture channelRejected(ChannelHandlerContext ctx, InetSocketAddress remoteAddress) {
                Assertions.assertTrue(ctx.channel().isActive());
                Assertions.assertTrue(ctx.channel().isWritable());
                Assertions.assertEquals("192.168.57.1", remoteAddress.getHostName());
        ...
        Assertions.assertEquals(7, out.readableBytes());
        for (byte i = 1; i <= 7; i++) {
            Assertions.assertEquals(i, out.readByte());
        }
        Assertions.assertFalse(chDeny.isActive());
        Assertions.assertFalse(chDeny.isOpen());
        ...
        Assertions.assertTrue(chAllow.isActive());
        Assertions.assertTrue(chAllow.isOpen());
    }
    ...
    public void testBinarySearch() {
        ...
        Assertions.assertFalse(ch1.isActive());
        Assertions.assertTrue(ch1.close().isSuccess());

        // Nothing applies here
        EmbeddedChannel ch2 = newEmbeddedInetChannel("2.2.2.2", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertTrue(ch2.isActive());
        Assertions.assertTrue(ch2.close().isSuccess());

        // 108.0.0.0/4
        EmbeddedChannel ch3 = newEmbeddedInetChannel("97.100.100.100", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertFalse(ch3.isActive());
        Assertions.assertTrue(ch3.close().isSuccess());

        // 200.200.200.200/32
        EmbeddedChannel ch4 = newEmbeddedInetChannel("200.200.200.200", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertFalse(ch4.isActive());
        Assertions.assertTrue(ch4.close().isSuccess());

        // Nothing applies here
        EmbeddedChannel ch5 = newEmbeddedInetChannel("127.0.0.1", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertTrue(ch5.isActive());
        Assertions.assertTrue(ch5.close().isSuccess());

        // 10.0.0.0/8
        EmbeddedChannel ch6 = newEmbeddedInetChannel("10.1.1.2", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertFalse(ch6.isActive());
        Assertions.assertTrue(ch6.close().isSuccess());

        // 2001:db8:abcd:0000::/52
        EmbeddedChannel ch7 = newEmbeddedInetChannel("2001:db8:abcd:1000::", new IpSubnetFilter(ipSubnetFilterRuleList));
        Assertions.assertFalse(ch7.isActive());
        Assertions.assertTrue(ch7.close().isSuccess());
    }
