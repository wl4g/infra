...
public final class PropertiesRegistryService implements GlobalRegistryService<Properties> {
    ...
    public PropertiesRegistryService(RegistryCenterRepository repository) {
    ...
    public Properties load() {
        return Strings.isNullOrEmpty(repository.get(GlobalNode.getPropsPath())) ? new Properties()
                : YamlEngine.unmarshal(repository.get(GlobalNode.getPropsPath()), Properties.class);
    }
