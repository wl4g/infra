...
public final class StatesNode2 {

    //
    // UPDATE for failover
    // 使用state2是为了确保以后与新版的shardingsphere不冲突,因为到目前5.0.0-beta为止,states目录还是空的
    //
    private static final String ROOT_NODE = "states2";
     ...
     *
     * @param dataSourceNodeFullPath
     *            data source node full path
