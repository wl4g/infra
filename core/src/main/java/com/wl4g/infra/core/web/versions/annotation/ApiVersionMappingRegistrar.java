 ...
 */
package com.wl4g.infra.core.web.versions.annotation;
...
import com.wl4g.infra.common.lang.SimpleVersionComparator;
import com.wl4g.infra.common.log.SmartLogger;
import com.wl4g.infra.core.web.versions.reactive.ApiVersionRequestHandlerMapping;

import static com.wl4g.infra.core.web.versions.annotation.EnableApiVersionManagement.*;
...
public class ApiVersionMappingRegistrar
		...
		if (!isNull(attrs)) {
			...
			if (isReactiveWebApplication(getClass().getClassLoader(), environment, resourceLoader)) {
				...
				registerRequestHandlerMapping(metadata, attrs, registry,
						com.wl4g.infra.core.web.versions.servlet.ApiVersionRequestHandlerMapping.class, beanNameGenerator);
			}
		}
	...
	/**
	 * Refer:
	 * {@link com.wl4g.infra.core.web.versions.servlet.ApiVersionRequestHandlerMapping#versionConfig}
	 * </br>
