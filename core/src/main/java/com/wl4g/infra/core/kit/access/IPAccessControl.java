 ...
 */
package com.wl4g.infra.core.kit.access;
...
/**
 * IP access white list control. </br>
 * 
...
public class IPAccessControl {
    ...
    // private static final String IPV4 = new
    // StringBuffer("^(1\\d{2}|2[0-4]\\d|25[0-5]|[1-9]\\d|[1-9])\\.")
    ...
    private final IPAccessProperties config;
