...
import com.wl4g.infra.support.notification.AbstractMessageNotifier;
import com.wl4g.infra.support.notification.GenericNotifyMessage;
import com.wl4g.infra.support.notification.NotificationException;
...
public class AliyunVmsMessageNotifier extends AbstractMessageNotifier<VmsNotifyProperties> {
     ...
     */
    public static final String KEY_VMS_ACTION = "VmsAction";

    /**
     * 语音文件的播放次数，取值范围为1~3。默认：2
     */
    public static final String KEY_VMS_PLAYTIMES = "VmsPlayTimes";

    /**
     * 语音文件播放的音量。取值范围为0~100，默认为100。
     */
    public static final String KEY_VMS_VOLUME = "VmsVolume";

    /**
     * 语速控制，取值范围：-500~500。 默认：100
     */
    public static final String KEY_VMS_SPEED = "VmsSpeed";
}