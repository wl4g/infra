 ...
 */
package com.wl4g.infra.integration.feign.springcloud.proxy;
...
import com.wl4g.infra.core.framework.proxy.ProxyInvocation;
import com.wl4g.infra.integration.feign.springcloud.proxy.FeignProviderProxiesConfigurer;
import com.wl4g.infra.integration.feign.springcloud.proxy.FeignProxyController;
import com.wl4g.infra.integration.feign.springcloud.proxy.FeignProxyInvocationHandler;
import com.wl4g.infra.integration.feign.springcloud.proxy.NoSuchFeignProxyBeanException;

import static com.wl4g.infra.common.collection.CollectionUtils2.safeMap;
import static com.wl4g.infra.common.lang.Assert2.notNullOf;
import static com.wl4g.infra.common.log.SmartLoggerFactory.getLogger;
import static com.wl4g.infra.integration.feign.springcloud.proxy.FeignProxyUtil.typeofDubboServiceBean;
import static com.wl4g.infra.integration.feign.springcloud.proxy.FeignProxyUtil.typeofMapperProxy;
