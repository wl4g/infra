 ...
 */
package com.wl4g.infra.metrics.client.health;
...
@CustomLog
@Deprecated
public class CustomHealthApplicationRunner implements ApplicationRunner, DisposableBean {
    ...
    public void run(ApplicationArguments args) throws Exception {
        this.executor = Executors.newFixedThreadPool(2, (r) -> {
            Thread t = new Thread(r, CustomHealthApplicationRunner.class.getSimpleName() + "-" + System.currentTimeMillis());
            if (t.isDaemon())
                t.setDaemon(false);
