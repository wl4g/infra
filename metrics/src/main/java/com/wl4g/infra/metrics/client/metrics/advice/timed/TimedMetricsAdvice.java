...
import com.wl4g.infra.metrics.client.exception.MetricsException;
import com.wl4g.infra.metrics.client.health.timed.TimedMethodHealthIndicator;
import com.wl4g.infra.metrics.client.metrics.advice.BaseMetricsAdvice;
 ...
 */
public class TimedMetricsAdvice extends BaseMetricsAdvice {

    @Autowired(required = false)
    private TimedMethodHealthIndicator timingIndicator; // Non-required
