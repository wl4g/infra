 ...
 */
@CustomLog
public class TimedMethodHealthIndicator extends AbstractHealthIndicator {

    private final Map<String, Deque<Long>> records = new ConcurrentHashMap<>(64);
    private TimedMethodProperties config;

    public TimedMethodHealthIndicator(TimedMethodProperties config) {
