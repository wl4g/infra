 ...
 */
package com.wl4g.infra.metrics.client.collector;

import static com.wl4g.infra.metrics.client.constants.MetricsInfraConstants.CONF_PREFIX_INFRA_COLLECTOR;
...
import com.wl4g.infra.metrics.client.metrics.MetricsFacade;
 ...
 */
@Configuration
@ConditionalOnProperty(name = CONF_PREFIX_INFRA_COLLECTOR + ".enabled", matchIfMissing = true)
public class ScrapeCollectorAutoConfiguration {

    @Bean
    @ConfigurationProperties(prefix = CONF_PREFIX_INFRA_COLLECTOR)
    ...
    @Bean
    public MetricsCollectorRunner metricsCollectorService(
