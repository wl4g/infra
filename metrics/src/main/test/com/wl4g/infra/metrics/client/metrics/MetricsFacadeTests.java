 ...
 */
package com.wl4g.infra.metrics.client.metrics;
...
public class MetricsFacadeTests {
    ...
    private final MetricsFacade metricsFacade = new MetricsFacade(new PrometheusMeterRegistry(PrometheusConfig.DEFAULT));
