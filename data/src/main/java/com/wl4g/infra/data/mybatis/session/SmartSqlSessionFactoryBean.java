 ...
 */
package com.wl4g.infra.data.mybatis.session;
...
import com.wl4g.infra.data.mybatis.logging.LogbackImpl;
 ...
 * @since
 */
public class SmartSqlSessionFactoryBean extends SqlSessionFactoryBean {
	...
	private void applyDefaultConfiguration() throws IOException {
		...
		if (nonNull(configLocation)) {
			...
			// Register typeAlias for logback supported.
