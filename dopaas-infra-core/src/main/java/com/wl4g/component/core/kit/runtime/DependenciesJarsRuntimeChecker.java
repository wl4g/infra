 ...
 */
package com.wl4g.component.core.kit.runtime;
...
public class DependenciesJarsRuntimeChecker implements InitializingBean {
	...
	@Configuration
	@ConditionalOnProperty(value = "spring.infra.dopaas.component.kit.runtime.depend-checker.enabled", matchIfMissing = true)
